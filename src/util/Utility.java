...
public class Utility {
	...
	public static boolean handleCitiesResponse(SimpleWeatherDB simpleWeatherDB,
	...
	public static boolean handleCountriesResponse(SimpleWeatherDB simpleWeatherDB,
		...
		if (!TextUtils.isEmpty(response)) {
			...
			if (allCountries != null && allCountries.length > 0) {
				for (String c : allCountries) {
					...
					simpleWeatherDB.saveCountry(country);
				}
			}
			return true;
		}
